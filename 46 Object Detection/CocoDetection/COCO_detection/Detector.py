...
import numpy as np
import sys
sys.path.insert(0,'./COCO_detection')
...
# label = ['bench', 'umbrella', 'knife', 'spoon', 'bowl', 'chair', 'couch', 'potted plant', 'bed', 'dining table', 'book', 'clock', 'vase']
...
def detect_img(img_path):
    ...
    # img = cv2.imread("chair (501).JPG")
    # img = cv2.imread("couch (609).JPG")
    label, count = detector.Detect(img)
    return label, count
